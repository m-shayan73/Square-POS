...
import { type CartStore, createCartStore } from '@/shared/stores/cart-store'
...
export const CartStoreProvider = ({ children }: CartStoreContextProps) => {
  ...
  return <CartStoreContext.Provider value={cartStore.current}>{children}</CartStoreContext.Provider>
}
